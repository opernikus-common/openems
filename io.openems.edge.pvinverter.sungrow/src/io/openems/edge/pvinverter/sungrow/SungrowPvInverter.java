...
public interface SungrowPvInverter extends OpenemsComponent {
	...
	TOTAL_RUNNING_TIME(Doc.of(OpenemsType.INTEGER).unit(Unit.HOUR).accessMode(AccessMode.READ_ONLY)
		.persistencePriority(PersistencePriority.VERY_LOW)),
	INTERNAL_TEMPERATURE(Doc.of(OpenemsType.INTEGER).unit(Unit.DEZIDEGREE_CELSIUS).accessMode(AccessMode.READ_ONLY)
		.persistencePriority(PersistencePriority.VERY_LOW)),
