	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		...
		var modbusProtocol = new ModbusProtocol(this,
				...
				new FC4ReadInputRegistersTask(1008, Priority.HIGH,
						m(Evcs.ChannelId.CURRENT_L1, new UnsignedWordElement(1008))),
				new FC4ReadInputRegistersTask(1010, Priority.HIGH,
						m(Evcs.ChannelId.CURRENT_L2, new UnsignedWordElement(1010))),
				new FC4ReadInputRegistersTask(1012, Priority.HIGH,
						m(Evcs.ChannelId.CURRENT_L3, new UnsignedWordElement(1012))),
