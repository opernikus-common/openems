...
public class CalculateEnergySession {
	...
	/**
	 * Updates the {@link Evcs.ChannelId#ENERGY_SESSION} from the {@link Evcs.ChannelId#ACTIVE_CONSUMPTION_ENERGY}.
	 * 
	...
	public void update(boolean isConnected) {
		if (isConnected) {
			...
			this.parent._setEnergySession((int) (this.parent.getActiveConsumptionEnergy().orElse(0L) - this.energyAtStartOfSession));
		}
