...
public enum EvcsGoeChargerHome implements io.openems.edge.common.channel.ChannelId {

	ALIAS(Doc.of(OpenemsType.STRING) //
			.text("A human-readable name of this Component")), //
	ALLOW_CHARGING(Doc.of(OpenemsType.INTEGER) //
			.text("allow charging")), //
	...
	STATUS_GOE(Doc.of(Status.values()) //
			.text("Current state of the charging station")), //
	ERROR(Doc.of(Errors.values()) //
			.text("")), //
	...
	private EvcsGoeChargerHome(Doc doc) {
		this.doc = doc;
	}
