...
public class ModuleRegister {
	...
	/**
	 * This Object contains the information of one Table entry (without the Register
	 * because this object is designed to be put in a Map where the value is the
	 * Register).
	 *
	 * @param moduleType   Type of the Module(e.g TMP,RELAY,etc.)
	 * @param moduleNumber Module number specified on the Device
	 * @param mReg         Usually the Position but sometimes Position-1. Check
	 *                     Register Map
	 */
	public ModuleRegister(ModuleType moduleType, int moduleNumber, int mReg) {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			return otherObject.moduleNumber == this.moduleNumber && otherObject.mReg == this.mReg
