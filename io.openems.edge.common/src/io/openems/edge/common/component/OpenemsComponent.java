...
public interface OpenemsComponent {
	 ...
	 *
	 * <pre>
	 * updateReferenceFilterIgnoreFactoryId(config.service_pid(), config.serviceFactoryId(), "Controllers",
	 * 		controllersIds);
	 * </pre>
	 *
	 * <p>
	 ...
	 *         activate() method.
	 */
	public static boolean updateReferenceFilterIgnoreFactoryId(ConfigurationAdmin cm, String pid, String factoryId,
															   String member, String... ids) {
		final var filter = ConfigUtils.generateReferenceTargetFilterIgnoreFactoryId(pid, factoryId, ids);
		return updateReferenceFilterRaw(cm, pid, member, filter);
	}
	// oEMS end
}
