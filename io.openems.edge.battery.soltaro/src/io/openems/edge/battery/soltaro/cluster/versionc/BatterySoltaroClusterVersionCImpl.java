...
public class BatterySoltaroClusterVersionCImpl extends AbstractOpenemsModbusComponent implements //
	...
	private CompletableFuture<Integer> getNumberOfModules() {
		return readFC3HoldingRegisterElementOnce(this.getModbusProtocol(), ModbusUtils::retryOnNull,
	...
	private void checkNumberOfTowers(BiPredicate<ExecuteState, Integer> retryPredicate,
		...
		readFC3HoldingRegisterElementOnce(this.getModbusProtocol(), retryPredicate, new UnsignedWordElement(address))
