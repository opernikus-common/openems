...
public interface Consts {
      ...
      ChannelAddress EVCS_ONE_CHARGE_POWER_LIMIT = new ChannelAddress(evcsOne,
            "SetChargePowerLimit");
      ChannelAddress EVCS_TWO_CHARGE_POWER_LIMIT = new ChannelAddress(evcsTwo,
              "SetChargePowerLimit");
      ChannelAddress EVCS_THREE_CHARGE_POWER_LIMIT = new ChannelAddress(evcsThree,
              "SetChargePowerLimit");
      ChannelAddress EVCS_FOUR_CHARGE_POWER_LIMIT = new ChannelAddress(evcsFour,
              "SetChargePowerLimit");
