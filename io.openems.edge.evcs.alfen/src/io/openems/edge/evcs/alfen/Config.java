...
@ObjectClassDefinition(//
		name = "EVCS Alfen", //
		description = "Implementation for the Alfen NG9xx charging station")
@interface Config {
	...
	int minHwPower() default Evcs.DEFAULT_MINIMUM_HARDWARE_POWER;

	@AttributeDefinition(name = "Maximum hardware power", description = "Maximum charging power of the Charger in W.", required = true)
	int maxHwPower() default Evcs.DEFAULT_MAXIMUM_HARDWARE_POWER;
