...
public class SungrowEssImpl extends AbstractOpenemsModbusComponent
	implements SungrowEss, SymmetricEss, ManagedSymmetricEss, HybridEss, StartStoppable, ModbusComponent, OpenemsComponent {
	...
	return new ModbusProtocol(this, //
		new FC4ReadInputRegistersTask(4989, Priority.HIGH, //
			...
			m(SungrowEss.ChannelId.DAILY_OUTPUT_ENERGY, new UnsignedWordElement(5002), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_OUTPUT_ENERGY, new UnsignedDoublewordElement(5003).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			...
			m(SungrowEss.ChannelId.TOTAL_DC_POWER, new UnsignedDoublewordElement(5016).wordOrder(WordOrder.LSWMSW)), //
			...
			m(SymmetricEss.ChannelId.REACTIVE_POWER, new SignedDoublewordElement(5032).wordOrder(WordOrder.LSWMSW)), //
		...
		new FC4ReadInputRegistersTask(12999, Priority.HIGH, //
			...
			m(SungrowEss.ChannelId.DAILY_PV_GENERATION, new UnsignedWordElement(13001), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_PV_GENERATION, new UnsignedDoublewordElement(13002).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.DAILY_EXPORT_POWER_FROM_PV, new UnsignedWordElement(13004), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_EXPORT_ENERGY_FROM_PV, new UnsignedDoublewordElement(13005).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(HybridEss.ChannelId.DC_DISCHARGE_POWER, new SignedDoublewordElement(13007).wordOrder(WordOrder.LSWMSW)), //
			m(SungrowEss.ChannelId.EXPORT_POWER, new SignedDoublewordElement(13009).wordOrder(WordOrder.LSWMSW)), //
			m(SungrowEss.ChannelId.DAILY_BATTERY_CHARGE_ENERGY_FROM_PV, new UnsignedWordElement(13011), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_BATTERY_CHARGE_ENERGY_FROM_PV, new UnsignedDoublewordElement(13012).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.CO2_REDUCTION, new UnsignedDoublewordElement(13014).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_MINUS_1), //
			m(SungrowEss.ChannelId.DAILY_DIRECT_ENERGY_CONSUMPTION, new UnsignedWordElement(13016), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_DIRECT_ENERGY_CONSUMPTION, new UnsignedDoublewordElement(13017).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			...
			m(SungrowEss.ChannelId.DAILY_BATTERY_DISCHARGE_ENERGY, new UnsignedWordElement(13025), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SymmetricEss.ChannelId.ACTIVE_DISCHARGE_ENERGY, new UnsignedDoublewordElement(13026).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			...
			m(SungrowEss.ChannelId.CURRENT_L3, new SignedWordElement(13032), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SymmetricEss.ChannelId.ACTIVE_POWER, new SignedDoublewordElement(13033)).wordOrder(WordOrder.LSWMSW), //
			m(SungrowEss.ChannelId.DAILY_IMPORT_ENERGY, new UnsignedWordElement(13035), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_IMPORT_ENERGY, new UnsignedDoublewordElement(13036).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			...
			m(SungrowEss.ChannelId.DAILY_CHARGE_ENERGY, new UnsignedWordElement(13039), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SymmetricEss.ChannelId.ACTIVE_CHARGE_ENERGY, new UnsignedDoublewordElement(13040).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			new DummyRegisterElement(13042, 13043), //
			m(SungrowEss.ChannelId.DAILY_EXPORT_ENERGY, new UnsignedWordElement(13044), //
				ElementToChannelConverter.SCALE_FACTOR_2), //
			m(SungrowEss.ChannelId.TOTAL_EXPORT_ENERGY, new UnsignedDoublewordElement(13045).wordOrder(WordOrder.LSWMSW), //
				ElementToChannelConverter.SCALE_FACTOR_2) //	
			), //
	...
	this.heartbeat++;
	this.heartbeat = (this.heartbeat - 1) % 20 + 1;
