...
public class VictronBatteryInverterImpl extends AbstractOpenemsModbusComponent
	...
	this._setMaxApparentPower(VictronBatteryInverterImpl.MAX_APPARENT_POWER);
	...
	return new ModbusProtocol(this, //
		...
		// m(Victron.ChannelId.MAX_CHARGE_VOLTAGE, new
		// UnsignedWordElement(2710),//ILLEGAL DATA ADDRESS
		// ElementToChannelConverter.SCALE_FACTOR_MINUS_1)
		)); //
