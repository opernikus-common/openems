...
public enum Phases implements OptionsEnum {
	...
	/**
	 * Convert integer to Phases object.
	 * 
	 * @param value the value
	 * @return the phases object, fitting to the given value or Phases.THREE_PHASE.
	 */
	public static Phases fromValue(int value) {
		if (Phases.ONE_PHASE.getValue() == value) {
			return Phases.ONE_PHASE;
		}
		if (Phases.TWO_PHASE.getValue() == value) {
			return Phases.TWO_PHASE;
		}
