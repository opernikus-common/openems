...
public enum Unit {
	 ...
	 * @return the converted value
	 */
	public int getAsBaseUnit(double value) { // oEMS
		return (int) (value * Math.pow(10, this.scaleFactor));
	}
	 ...
	 * @return the converted value.
	 */
	public int convertToScaledUnit(int value, Unit unit) { // oEMS
	 ...
	 * @return the converted value.
	 */
	public double convertToScaledUnit(double value, Unit unit) { // oEMS
		if (this.baseUnit == unit.baseUnit || this == unit.baseUnit) {
