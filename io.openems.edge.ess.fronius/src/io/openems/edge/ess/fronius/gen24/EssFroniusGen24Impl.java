...
public class EssFroniusGen24Impl extends AbstractOpenemsSunSpecComponent
		implements ManagedSymmetricEss, SymmetricEss, OpenemsComponent {

	private final Logger log = LoggerFactory.getLogger(EssFroniusGen24Impl.class);
	...
	private static final Map<SunSpecModel, Priority> ACTIVE_MODELS = ImmutableMap.<SunSpecModel, Priority>builder()
			...
			.put(FroniusSunSpecModel.S_160, Priority.HIGH) // GEN24
			.build();
	...
	public EssFroniusGen24Impl() throws OpenemsException {
		super(//
				ACTIVE_MODELS, //
	...
	protected void onSunSpecInitializationCompleted() {
		...
		this.mapFirstPointToChannel(EssFroniusGen24.CHARGE_POWER, ElementToChannelConverter.DIRECT_1_TO_1,
				FroniusSunSpecModel.S160.MODULE_3_D_C_W);
		this.mapFirstPointToChannel(EssFroniusGen24.DISCHARGE_POWER, ElementToChannelConverter.DIRECT_1_TO_1,
				FroniusSunSpecModel.S160.MODULE_4_D_C_W);
	...
	public void applyPower(int activePower, int reactivePower) throws OpenemsNamedException {
		...
		this.channel(EssFroniusGen24.REQUESTED_ACTIVE_POWER).setNextValue(activePower);
	...
	public Channel<Integer> getChargePowerChannel() {
		return this.channel(EssFroniusGen24.CHARGE_POWER);
	}

	public Channel<Integer> getDischargePowerChannel() {
		return this.channel(EssFroniusGen24.DISCHARGE_POWER);
	}
