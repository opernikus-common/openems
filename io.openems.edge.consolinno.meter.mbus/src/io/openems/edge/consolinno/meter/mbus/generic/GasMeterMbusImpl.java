...
public class GasMeterMbusImpl extends AbstractOpenemsMbusComponent
	...
	protected void addChannelDataRecords() {
		this.addToChannelDataRecordListIfDefined(channel(GasMeterMbus.ChannelId.READING_POWER),
				this.config.meterReading());
		this.addToChannelDataRecordListIfDefined(channel(GasMeterMbus.ChannelId.FLOW_RATE),
		...
		this.addToChannelDataRecordListIfDefined(channel(GasMeterMbus.ChannelId.FLOW_TEMP),
