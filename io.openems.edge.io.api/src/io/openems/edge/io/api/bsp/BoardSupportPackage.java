package io.openems.edge.io.api.bsp;
...
public interface BoardSupportPackage extends DigitalOutput, DigitalInput, OpenemsComponent {
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		/**
		 * Digital Output or Relais output 2.
		 *
		 * <ul>
		 * <li>Type: Boolean
		 * <li>Range: On/Off
		 * </ul>
		 */
		DIGITAL_OUT2(new BooleanDoc() //
				.unit(Unit.ON_OFF) //
				.accessMode(AccessMode.READ_WRITE) //
				.persistencePriority(PersistencePriority.MEDIUM) //
		), //
		/**
		 * Digital Output or Relais output 3.
		 *
		 * <ul>
		 * <li>Type: Boolean
		 * <li>Range: On/Off
		 * </ul>
		 */
		DIGITAL_OUT3(new BooleanDoc() //
				.unit(Unit.ON_OFF) //
				.accessMode(AccessMode.READ_WRITE) //
				.persistencePriority(PersistencePriority.MEDIUM) //
		), //
		/**
		 * Digital Output or Relais output 4.
		 *
		 * <ul>
		 * <li>Type: Boolean
		 * <li>Range: On/Off
	...
	/**
	 * Gets the Channel for {@link ChannelId#UPTIME}.
	 *
	 * @return the Channel
	 */
	public default IntegerReadChannel getUptimeChannel() {
		return this.<IntegerReadChannel>channel(ChannelId.UPTIME);
	}

	/**
	 * Gets the Uptime of OpenEMS in [Minutes]. See {@link ChannelId#UPTIME}.
	 *
	 * @return the Channel {@link Value}
	 */
	public default Value<Integer> getUptime() {
		return this.getUptimeChannel().value();
	}
	...
	public default BooleanWriteChannel getDigitalOut2WriteChannel() {
		return this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT2);
	}

	public default Optional<Boolean> getDigitalOut2WriteValue() {
		return this.getDigitalOut2WriteChannel().value().asOptional();
	}

	public default Optional<Boolean> getDigitalOut2WriteValueAndReset() {
		return this.getDigitalOut2WriteChannel().getNextWriteValueAndReset();
	}

	public default void setDigitalOut2Value(Boolean value) {
		this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT2).setNextValue(value);
	}

	public default BooleanWriteChannel getDigitalOut3WriteChannel() {
		return this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT3);
	}

	public default Optional<Boolean> getDigitalOut3WriteValue() {
		return this.getDigitalOut3WriteChannel().value().asOptional();
	}

	public default Optional<Boolean> getDigitalOut3WriteValueAndReset() {
		return this.getDigitalOut3WriteChannel().getNextWriteValueAndReset();
	}

	public default void setDigitalOut3Value(Boolean value) {
		this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT3).setNextValue(value);
	}

	public default BooleanWriteChannel getDigitalOut4WriteChannel() {
		return this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT4);
	}

	public default Optional<Boolean> getDigitalOut4WriteValue() {
		return this.getDigitalOut4WriteChannel().value().asOptional();
	}

	public default Optional<Boolean> getDigitalOut4WriteValueAndReset() {
		return this.getDigitalOut4WriteChannel().getNextWriteValueAndReset();
	}

	public default void setDigitalOut4Value(Boolean value) {
		this.<BooleanWriteChannel>channel(ChannelId.DIGITAL_OUT1).setNextValue(value);
	}
