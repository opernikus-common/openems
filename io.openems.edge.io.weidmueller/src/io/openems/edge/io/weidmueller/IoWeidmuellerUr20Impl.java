...
import static io.openems.edge.bridge.modbus.api.ModbusUtils.readFC3HoldingRegisterElementsOnce;
...
public class IoWeidmuellerUr20Impl extends AbstractOpenemsModbusComponent
	...
	private CompletableFuture<Integer> readNumberOfEntriesInTheCurrentModuleList() {
		return readFC3HoldingRegisterElementOnce(this.modbusProtocol, ModbusUtils::retryOnNull, new UnsignedWordElement(0x27FE));
	}
	...
	private CompletableFuture<List<Long>> readCurrentModuleList(int numberOfEntries) {
		...
		return readFC3HoldingRegisterElementsOnce(this.modbusProtocol, ModbusUtils::retryOnNull, elements) //
